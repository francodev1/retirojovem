...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-900">
      ...
      {/* Footer */}
      <footer className="bg-slate-950 border-t border-orange-400/20 py-8 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-orange-300 mb-2">© 2026 Retiro Closer. Todos os direitos reservados.</p>
